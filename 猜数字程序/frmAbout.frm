...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "程序版权：Copyright (C)2010 MaxXSoft.All rights reserved."
      Height          =   375
      Left            =   1440
      TabIndex        =   7
      Top             =   600
   ...
   Begin VB.Label lblDescription 
      BackStyle       =   0  'Transparent
      Caption         =   "猜出系统挑选出的由1、2、3、4随机组成的四位数，否则游戏失败。"
      ForeColor       =   &H00000000&
      Height          =   1170
      Left            =   1440
      TabIndex        =   3
   ...
   Begin VB.Label lblVersion 
      BackStyle       =   0  'Transparent
      Caption         =   "版本 3.0.0                                                 GTN:Version 2.0.0"
      Height          =   255
      Left            =   120
      TabIndex        =   6
      Top             =   3600
